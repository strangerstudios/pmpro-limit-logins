...
### How PMPro Limit Logins Protects Shared User Logins
...
* If the two values do no match, PMPro Limit Logins logs the user out and redirects them to the WordPress login page or a custom page using the pmpro_limit_logins_redirect_url filter.
...
By default, PMPro Limit Logins only allows one session per user. 
...
### Example Use Cases for PMPro Limit Logins
...
### Install PMPro Limit Logins from within WordPress

1. Visit the plugins page within your dashboard and select "Add New"
1. Search for "PMPro Limit Logins"
1. Locate this plugin and click "Install"
1. Activate "PMPro Limit Logins" through the "Plugins" menu in WordPress

### Install PMPro Limit Logins Manually
...
* Filters renamed but maintain backward compatibility
* Automatically deactivate WP Bouncer
